...
<body class="login-page sidebar-collapse">
  ...
  <div class="page-header clear-filter" filter-color="orange">
    <div class="page-header-image" style="background-image:url('<?php echo base_url(); ?>/assets/web.jpg')"></div>
    <div class="content">
      <div class="container">
        <div class="col-md-4 ml-auto mr-auto">
          <div class="card card-login card-plain">
            <form class="form" method="post" >
			 ...
			 <h1 style="font-weight:600; font-family: Arial, Helvetica, sans-serif;"> TECHSYDNEY  </h1>
...
<button name="submit"  class="btn btn-primary btn-round btn-lg btn-block" type="submit">Login Now
			</button>
